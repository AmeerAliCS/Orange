      ...
      >
        <Box width={{ md: "50%", xs: 1 }}>
          ...
          >
            ...
            اداري خاص ، تطبيق موبايل اندرويد و IOS ,عمل موقع ويب خاص ...) باسرع
            وقت واقل تكلفه متواجدين 7/24 كل ما عليك هو اعطاء المعلومات اللازمة
            ونحن نتكفل في الباقي
          </Typography>
        </Box>
        <Box
          component="img"
      ...
      >
        <Box width={{ md: "50%", xs: 1 }}>
          ...
          >
            ...
            UI|UX بالاضافة الى العديد من الخدمات الاخرى مثل ادارة الصفحات وادارة
            الاعلانات وتصميم كافة البوسترات الخاصه بعملك لتكن مميزا دوماوت
            الشخصية وتصاميم UI|UX بالاضافة الى العديد من الخدمات الاخرى مثل
            ادارة الصفحات وادارة الاعلانات وتصميم كافة البوسترات الخاصه بعملك
            لتكن مميزا دوما{" "}
          </Typography>
        </Box>
        <Box
