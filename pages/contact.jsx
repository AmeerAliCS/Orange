        ...
        <>
           ...
           وكذلك تمتاز التصاميم المقدمة من منصتنا بأنها تصاميم عصرية تواكب التطور "
            ...
            <Box sx={{
                ...
                <Typography fontSize={{xs: 16, sm: 22}} display="block" textAlign="center">
                ...
                <Box dir="rtl" sx={{
                    ...
                    <div>
                        <TextField placeholder="اسمك" type="text"
                                   sx={{
                                       width: "35%"
                                   }}/>
                        <TextField placeholder="البريد الالكتروني" type="email" sx={{
                            width: "60%",
                            mr: "5%"
                        }}/>
                    </div>
                    <div>
                        <TextField placeholder="نوع الخدمة التي تريدها" type="text" sx={{
                            pt: 3,
                            width: "100%"
                        }}/>
                    </div>
